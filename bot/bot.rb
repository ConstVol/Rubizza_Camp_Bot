...
token = '400014709:AAFsTLjP6ryvTyEUbERgdMkV9lvsU6jukrI'
          ...
          if message.text[0] == '/'
            ...
            case message.text
              ...
              when "/start"
                ...
                bot.api.sendMessage(chat_id: message.chat.id, text:user_manager.execute_start(message.from.first_name))
